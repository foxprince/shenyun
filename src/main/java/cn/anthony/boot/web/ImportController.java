...
public class ImportController extends GenericController<ImportModel> {
    ...
    public @ResponseBody Page<ImportModel> ajaxList(@RequestParam String type, @PageableDefault Pageable pageable,
	    Model m) {
	...
	try {
	    ...
	    String dstPath = Paths.get(directory, type + "_"
		    + DateUtil.format(Calendar.getInstance().getTime(), "yyyyMMddHHmmssSSS") + "_" + filename)
		    .toString();
	    ...
	    // 3：生成纪录
	    int operator = 0;
	    ImportModel model = new ImportModel(type, filename, dstPath, ir.getTotal(), ir.getSuccess(),
		    ir.getInsertTotal(), ir.getInsertList(), ir.getUpdateTotal(), ir.getUpdateList(), operator);
			...
			if (StringTools.checkNull(pId) != null) {
			    ...
			    p.getExtendMap().put(type,
				    new ExtendObject.ICU(l.get(1), l.get(2), l.get(3), pId, l.get(5), l.get(6),
					    ...
					    l.get(21), l.get(22), l.get(23), l.get(24), l.get(25), l.get(26), l.get(27),
					    l.get(28), l.get(29), l.get(30)));
			    patientServ.create(p);
			    success++;
			}
		    } catch (Exception e) {
			...
			if (StringTools.checkNull(pId) != null) {
			    ...
			    p.getExtendMap().put(type,
				    new ExtendObject.Jzz(l.get(1), l.get(2), l.get(3), pId, l.get(5), l.get(6),
					    ...
					    l.get(14), l.get(15), l.get(16), l.get(17), l.get(18), l.get(19), l.get(20),
					    l.get(21), l.get(22), l.get(23), l.get(24), l.get(25), l.get(26), l.get(27),
					    l.get(28), l.get(29), l.get(30), l.get(31), l.get(32), l.get(33)));
			    patientServ.create(p);
			    success++;
			}
		    } catch (Exception e) {
		...
		for (Map.Entry<Integer, List<String>> entry : map.entrySet()) {
			...
			if (StringTools.checkNull(pId) != null) {
			    ...
			    p.getExtendMap().put(type, new ExtendObject.Bflz(l.get(1), l.get(2), l.get(3), l.get(4),
				    ...
				    l.get(13), l.get(14), l.get(15), l.get(16), l.get(17), l.get(18), l.get(19),
				    l.get(20), l.get(21), l.get(22), l.get(23), l.get(24), l.get(25), l.get(26),
				    l.get(27), l.get(28), l.get(29), l.get(30), l.get(31), l.get(32), l.get(33),
				    l.get(34), l.get(35), l.get(36), l.get(37), l.get(38), l.get(39), l.get(40),
				    l.get(41), l.get(42), l.get(43), l.get(44), l.get(45), l.get(46), l.get(47),
				    l.get(48), l.get(49), l.get(50), l.get(51), l.get(52), l.get(53), l.get(54),
				    l.get(55), l.get(56), l.get(57), l.get(58), l.get(59), l.get(60), l.get(61),
				    l.get(62), l.get(63), l.get(64), l.get(65), l.get(66), l.get(67), l.get(68),
				    l.get(69), l.get(70), l.get(71), l.get(72), l.get(73), l.get(74), l.get(75),
				    l.get(76), l.get(77), l.get(78), l.get(79), l.get(80), l.get(81), l.get(82),
				    l.get(83), l.get(84), l.get(85), l.get(86), l.get(87), l.get(88), l.get(89),
				    l.get(90), l.get(91), l.get(92), l.get(93), l.get(94), l.get(95), l.get(96),
				    l.get(97), l.get(98), l.get(99), l.get(100), l.get(101), l.get(102), l.get(103),
				    l.get(104), l.get(105), l.get(106), l.get(107), l.get(108), l.get(109), l.get(110),
				    l.get(111), l.get(112), l.get(113), l.get(114), l.get(115), l.get(116), l.get(117),
				    l.get(118), l.get(119), l.get(120), l.get(121), l.get(122), l.get(123), l.get(124),
				    l.get(125), l.get(126), l.get(127), l.get(128), l.get(129), l.get(130), l.get(131),
				    l.get(132), l.get(133), l.get(134), l.get(135), l.get(136), l.get(137), l.get(138),
				    l.get(139), l.get(140), l.get(141)));
			    patientServ.create(p);
			    success++;
			}
		    } catch (Exception e) {
