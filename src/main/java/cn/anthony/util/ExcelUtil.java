...
public class ExcelUtil {
	 ...
	 *            excel的列名
	 */
	public static Workbook createWorkBook(XSSFWorkbook wb, List<Map<String, Object>> list, String[] keys, String columnNames[]) {
		// 创建第一个sheet（页），并命名
	...
	private static String getStringCellValue(Cell cell) {
		...
		if (cell != null) {
			...
			/*
			 * switch (cell.getCellType()) { case Cell.CELL_TYPE_STRING: strCell
			 * = cell.getStringCellValue(); break; case Cell.CELL_TYPE_NUMERIC:
			 * if
			 * (org.apache.poi.ss.usermodel.DateUtil.isCellDateFormatted(cell))
			 * strCell =
			 * DateUtil.format(org.apache.poi.ss.usermodel.DateUtil.getJavaDate(
			 * cell.getNumericCellValue()),"yyyy-MM-dd"); else strCell =
			 * String.valueOf(cell.getNumericCellValue()); break; case
			 * Cell.CELL_TYPE_BOOLEAN: strCell =
			 * String.valueOf(cell.getBooleanCellValue()); break; case
			 * Cell.CELL_TYPE_BLANK: strCell = ""; break; default: strCell = "";
			 * break; }
			 */
		}
		return strCell;
