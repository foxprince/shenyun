  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        ...
        <form:form modelAttribute="customeOption"  method="POST" id="add-user-form" action="/customeOption/${customeOption.action}">
...
<div class="box-body">
  <div class="box box-info">
    <div class="box-header">
      <h3 class="box-title">基本条件</h3><label><input id="patientCheckAll" type="checkbox" >全选</label>
    ...
    <div class="box-body pad">
      <div class="form-group">
        <c:forEach  var="item" items="${patientOptions}">
          <label><form:checkbox class="minimal" op="patient" value="${item.name}" path="fields" />${item.label}</label>
  ...
  <div class="box box-primary">
    <div class="box-header">
      <h3 class="box-title">病案首页</h3><label><input id="frontPageCheckAll" type="checkbox" >全选</label>
      <!-- tools box -->
      <div class="pull-right box-tools">
    ...
    <div class="box-body pad">
      <div class="form-group">
        <c:forEach var="item" items="${frontPageOptions}">
           <label><form:checkbox class="minimal" value="${item.name}" op="frontPage" path="fields" />${item.label}</label>
          <i style="margin:0px 10px">|</i>
        </c:forEach>
       </div>
    </div>
  ...
  <div class="box box-warning">
    <div class="box-header">
      <h3 class="box-title">入院选项</h3><label><input id="inHospitalCheckAll" type="checkbox" >全选</label>
      <!-- tools box -->
      <div class="pull-right box-tools">
    ...
    <div class="box-body pad">
      <div class="form-group">
        <c:forEach var="item" items="${inOptions}">
           <label><form:checkbox class="minimal" value="${item.name}" op="inHospital" path="fields" />${item.label}</label>
          <i style="margin:0px 10px">|</i>
        </c:forEach>
      </div>
    </div>
  ...
  <div class="box box-danger">
    <div class="box-header">
      <h3 class="box-title">手术选项</h3><label><input id="operationCheckAll" type="checkbox" >全选</label>
      <!-- tools box -->
      <div class="pull-right box-tools">
      <button class="btn btn-danger btn-sm" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
      <button class="btn btn-danger btn-sm" data-widget="remove" data-toggle="tooltip" title="Remove"><i class="fa fa-times"></i></button>
    ...
    <div class="box-body pad">
      <div class="form-group">
        <c:forEach var="item" items="${operationOptions}">
           <label><form:checkbox class="minimal" value="${item.name}" op="operation" path="fields" />${item.label}</label>
          <i style="margin:0px 10px">|</i>
        </c:forEach>
      </div>
    </div>
  ...
  <div class="box box-success">
    <div class="box-header">
      <h3 class="box-title">出院选项</h3><label><input id="outHospitalCheckAll" type="checkbox" >全选</label>
      <!-- tools box -->
      <div class="pull-right box-tools">
    ...
    <div class="box-body pad">
      <div class="form-group">
        <c:forEach var="item" items="${outOptions}">
           <label><form:checkbox class="minimal" value="${item.name}" op="outHospital" path="fields" />${item.label}</label>
          <i style="margin:0px 10px">|</i>
        </c:forEach>
      </div>
    </div>
  ...
  <div class="box-header with-border">
      <label>选项名称：</label><form:input path="name" />
