...
public interface ImportModelRepository
	extends PagingAndSortingRepository<ImportModel, String>, QueryDslPredicateExecutor<ImportModel>, QuerydslBinderCustomizer<QImportModel> {
    @Override
