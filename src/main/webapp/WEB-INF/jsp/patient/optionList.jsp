									...
									<tbody>
										<c:forEach var="item" items="${itemList}">
											<tr>
												...
												<td><a href="/customeOption/edit?id=${item.id}"><button
															class="btn btn-block btn-info">查看/修改</button></a></td>
												<td><a href="/customeOption/delete?id=${item.id}"><button
															class="btn btn-block btn-warning">删除</button></a></td>
											</tr>
										</c:forEach>
									</tbody>
									<tfoot>
