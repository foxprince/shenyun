            ...
            <div class="col-md-3">
              ...
              <div class="box box-primary">
                <div class="box-body box-profile">
                  ...
                  <h3 class="profile-username text-center">尼娜</h3>
                  <p class="text-muted text-center">主病</p>

                  <ul class="list-group list-group-unbordered">
                    <li class="list-group-item">
                      <b>年龄</b> <a class="pull-right">1,322</a>
                    </li>
                    <li class="list-group-item">
                      <b>住院次数</b> <a class="pull-right">543</a>
                    </li>
                    <li class="list-group-item">
              ...
              <div class="box box-primary">
                ...
                <div class="box-body">
                  <strong><i class="fa fa-book margin-r-5"></i>  病史</strong>
                  <p class="text-muted">
            ...
            <div class="col-md-9">
              <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                  <li class="active"><a href="#inHospital" data-toggle="tab">入院纪录</a></li>
                ...
                <div class="tab-content">
                  <div class="active tab-pane" id="inHospital">
                    <!-- Post -->
                    <div class="post">
